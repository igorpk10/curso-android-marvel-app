...
import com.igaopk10.core.domain.model.SortingType
...
class SortFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        private const val FLIPPER_CHILD_BUTTON_LOADING = 1
        ...
        viewModel.state.observe(viewLifecycleOwner) { uiState ->
            when (uiState) {
                ...
                SortViewModel.UiState.ApplyState.Loading ->
                    binding.flipperApply.displayedChild = FLIPPER_CHILD_BUTTON_LOADING
