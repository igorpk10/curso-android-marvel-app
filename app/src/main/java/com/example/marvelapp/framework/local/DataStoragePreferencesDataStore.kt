...
import com.igaopk10.core.data.StorageConstants
...
class DataStoragePreferencesDataStore @Inject constructor(
    ...
    private val sortingKey = stringPreferencesKey(name = StorageConstants.SORT_ORDER_BY_KEY)
