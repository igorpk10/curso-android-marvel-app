...
class GetCharacterCategoriesImplTest {
    ...
    private lateinit var getCharactersUseCase: GetCharacterCategoriesImpl
    ...
    @Before
    fun setup() {
        getCharactersUseCase = GetCharacterCategoriesImpl(
            repository,
